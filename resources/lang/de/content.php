...
return [
    ...
    'main_heading' => 'Halal-Zertifizierungsdienste Deutschland',
    'main_subheading' => 'Halal Certification Services (HCS) (EU) ist ein erfahrenes und weltweit anerkanntes und angesehenes Zertifizierungsunternehmen, das Bewertungs-, Audit- und Schulungsdienste anbietet.',
    'partner_message' => 'Vertrauen von Unternehmen weltweit',
    'section_heading' => 'Halal-Zertifizierungsdienste',
    'section_message_1' => 'Halal Certification Services (HCS) (EU) ist ein erfahrenes und weltweit anerkanntes und angesehenes Zertifizierungsunternehmen, das Bewertungs-, Audit- und Schulungsdienste anbietet.',
    'section_message_2' => 'HCS(EU) mit Sitz in Deutschland unterstützt Zutaten-, Lebensmittel-, Pharma- und Kosmetikhersteller dabei, die Anforderungen des Halal-Marktes zu erfüllen.',
    'section_message_3' => 'HCS (EU) ist Mitglied des World Halal Food Council und wird offiziell von renommierten Organisationen aus der ganzen Welt wie MUI (Indonesien), JAKIM (Malaysia) und MUIS (Singapur) anerkannt.',
    'about_section_title' => 'Über uns',
    'about_button' => 'Mehr über uns',

    'about_section_heading' => 'Wir möchten Ihnen für Ihre Absicht danken, mehr über uns und unsere Organisation zu erfahren.',
    'about_section_message_1' => 'Die Halal Certification Services (EU) GmbH wurde von einem Schweizer Unternehmen initiiert, um ihre Dienstleistungen auf Europa auszudehnen. Das Büro mit Sitz in Süddeutschland betreut seine deutschen Kunden und ermöglicht eine Präsenz auf dem EU-Markt. HCS (EU) kann die Branche durch seine eigenen erfahrenen Auditoren professionell bedienen.',
    'about_section_message_2' => 'Inzwischen ist Halal Certification Services (EU) eine weltweit anerkannte und angesehene Stelle. HCS (EU) arbeitet kontinuierlich an der Sensibilisierung für Halal und ist bestrebt, die Vielfalt der Halal-zertifizierten Produkte zu erhöhen.',
    'history_title' => 'Unsere Geschichte',
    'history_message_1' => "Halal Certification Services (EU) GmbH ist ein junges Unternehmen. Es wurde 2015 ins Leben gerufen und hofft, seine Bedeutung schrittweise auszubauen und seinen Platz im aufstrebenden Halal-Markt zu finden.",
    'history_message_2' => "HCS (EU) soll eine Anlaufstelle für die deutsche Industrie sein, die bestrebt ist, den Bedürfnissen des Halal-Marktes gerecht zu werden.",
